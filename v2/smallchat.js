...
$.Velocity
  .RegisterEffect('smallchat.fadeIn', {
    defaultDuration: 300,
    calls: [[ { opacity: [1, 0] }, 1, { easing: [.25, .1, .25, 1] } ]]
  })
  ...
  .RegisterEffect('smallchat.slideRightIn', {
    defaultDuration: 300,
    calls: [[ { opacity: [1, 0], translateX: [0, -10], translateZ: 0 }, 1, { easing: [.25, .1, .25, 1] } ]]
  })
  .RegisterEffect('smallchat.slideLeftOut', {
    defaultDuration: 300,
    reset: { translateX: 0 },
    calls: [[ { opacity: 0, translateX: -10, translateZ: 0 }, 1, { easing: [.25, .1, .25, 1] } ]]
  })
  .RegisterEffect('smallchat.slideRightOut', {
    defaultDuration: 300,
    calls: [[ { opacity: 0, translateX: [0, -10], translateZ: 0 }, 1, { easing: [.25, .1, .25, 1] } ]]
  })
  .RegisterEffect('smallchat.slideLeftIn', {
    defaultDuration: 300,
    reset: { translateX: 0 },
    calls: [[ { opacity: [1, 0], translateX: -10, translateZ: 0 }, 1, { easing: [.25, .1, .25, 1] } ]]
  })
